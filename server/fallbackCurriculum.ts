import type { ModulInputData } from '../src/types.ts';
...
export function generateStructuredModulAjar(data: Partial<ModulInputData>): string {
...
export function generateStructuredIceBreaking(
  arg1?: any,
  arg2?: any,
  arg3?: any
): string {
  const materi = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.materi || 'Materi PAI SD') : (arg1 || 'Materi PAI SD');
  const faseKelas = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.faseKelas || 'Fase B (SD Kelas 3-4)') : (arg2 || 'Fase B (SD Kelas 3-4)');
  const durasi = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.durasi || '5 - 7 Menit') : (arg3 || '5 - 7 Menit');
  const elemen = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.elemen || '') : '';
  const tk = resolveThematicKnowledge(materi, elemen);

  return `# PANDUAN ICE BREAKING EDUKATIF & JOYFUL LEARNING PAI
## MATERI POKOK: ${materi.toUpperCase()}
**Pendekatan:** Joyful & Meaningful Learning &mdash; Rahmatan lil 'Alamin (${durasi}, ${faseKelas})

---

### 1. ICE BREAKING UTAMA: "Gema Kasih Sayang & Estafet Kebaikan"
- **Durasi**: ${durasi}
- **Tujuan**: Menghadirkan rasa aman psikologis (*psychological safety*), menyegarkan fokus belajar, dan menumbuhkan rasa saling mengapresiasi antarteman sekelas.
- **Aturan Main**:
  1. Guru meminta seluruh murid berdiri melingkar atau berpasangan dengan teman sebangku.
  2. Guru menyebutkan kata kunci: *"Ketika Bapak/Ibu berkata 'Cahaya Iman', pegang pundak temanmu dengan lembut dan katakan 'Semangat sahabatku!'"*
  3. *"Ketika Bapak/Ibu berkata 'Bintang Kebaikan', tersenyumlah dan sebutkan satu sifat baik dari teman di sampingmu!"*
  4. Seluruh kelas melafalkan bersama: *"Kami Anak Shalih, Saling Menyayangi Karena Allah!"*

### 2. YEL-YEL & TEPUK CERIA: "Tepuk Mutiara Ilmu ${materi}"
- *Tepuk Mutiara Ilmu!* (Prok prok prok)
- *Buka Hati...* (Prok prok prok - Senyum Ramah!)
- *Raih Ilmu...* (Prok prok prok - Nalar Kritis!)
- *Jaga Lisan...* (Prok prok prok - Kata Santun!)
- *Sayang Teman...* (Prok prok prok - Tanpa Bullying!)
- *PAI SD Hebat...* (Prok prok prok - Shalih, Cerdas, Bahagia! Yesss!)

### 3. GAME FOKUS: "Tebak Kata Hikmah"
- Guru menampilkan 3 kata kunci dari materi (${tk.istilahKunci.map(i => i.istilah.split(' ')[0]).join(', ')}) dan meminta perwakilan siswa memeragakannya dengan gerakan tubuh santun tanpa berbicara untuk ditebak kelompoknya.`;
}

export function generateStructuredLkpd(
  arg1?: any,
  arg2?: any,
  arg3?: any,
  arg4?: any
  ...
  const materi = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.materi || 'Materi PAI SD') : (arg1 || 'Materi PAI SD');
  const faseKelas = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.faseKelas || 'SD Kelas 3-4') : (arg2 || 'SD Kelas 3-4');
  const elemen = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.elemen || '') : (arg3 || '');
  const modelPembelajaran = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.metodePembelajaran || 'Problem Based Learning') : (arg4 || 'Problem Based Learning');
  const tk = resolveThematicKnowledge(materi, elemen);

  return `# LEMBAR KERJA PESERTA DIDIK (LKPD) MULTI-PLATFORM & DEEP LEARNING
## MEMBANGUN AKHLAK MULIA & NALAR KRITIS: ${materi.toUpperCase()}
**Jenjang / Fase:** ${faseKelas} | **Elemen:** ${elemen || 'PAI'} | **Model:** ${modelPembelajaran}
...
1. Bacalah basmalah sebelum memulai kegiatan bersama kelompokmu.
2. Diskusikan setiap kasus dengan saling menghargai pendapat tanpa memotong pembicaraan kawan.
3. Tuliskan hasil analisis kelompokmu dengan rapi dan penuh tanggung jawab.

---

## 🌟 AKTIVITAS 1: MINDFUL TADABBUR (TELAAH MAKNA & DALIL NAQLI)
Perhatikan firman Allah Swt. berikut:
> **${tk.dalilQuran.arab}**  
> *"${tk.dalilQuran.terjemah}"* (${tk.dalilQuran.surah})

**Pertanyaan Analisis:**
1. Apa pesan utama yang disampaikan oleh firman Allah Swt. di atas?
   *Jawaban:* ............................................................................................................
2. Bagaimana cara kalian menerapkan pesan ayat tersebut dalam kehidupan di sekolah?
   *Jawaban:* ............................................................................................................

---

## 🔍 AKTIVITAS 2: MEANINGFUL INQUIRY (STUDI KASUS EMPATI MORAL)
**Studi Kasus Kontekstual:**
> *${tk.studiKasusAwal.narasi}*

**Tantangan Diskusi:**
1. Pelajaran akhlak berharga apa yang dapat diambil dari sikap tokoh dalam cerita di atas?
   *Jawaban Kelompok:* ............................................................................................................
2. Jika kalian berada dalam situasi tersebut, tindakan kebaikan apa yang akan kalian lakukan?
   *Jawaban Kelompok:* ............................................................................................................

---

## 📋 BAGIAN I: SOAL PILIHAN GANDA PENALARAN TINGKAT TINGGI (10 SOAL HOTS)
${tk.soalHots.map(s => `
**${s.nomor}. ${s.stimulus}**  
A. ${s.opsi.A}  
B. ${s.opsi.B}  
...
## 📋 FORMAT KHUSUS GOOGLE FORMS (SIAP SALIN-TEMPEL)
\`\`\`text
Judul Formulir: LKPD PAI - ${materi}
Deskripsi: Kerjakan soal evaluasi PAI materi ${materi} dengan jujur dan teliti!

${tk.soalHots.map((s, idx) => `[SOAL ${idx + 1} - PILIHAN GANDA]
Pertanyaan: ${s.stimulus}
Opsi A: ${s.opsi.A}
Opsi B: ${s.opsi.B}
Opsi C: ${s.opsi.C}
Opsi D: ${s.opsi.D}
Kunci Jawaban: ${s.kunci}
Poin: 10
...
## ⚡ FORMAT TABEL QUIZZIZ & KAHOOT (SIAP IMPOR)
| No | Question Text | Question Type | Option 1 | Option 2 | Option 3 | Option 4 | Correct Answer | Time (s) |
|:--:|:---|:---:|:---|:---|:---|:---|:---:|:---:|
${tk.soalHots.map((s, idx) => `| ${idx + 1} | ${s.stimulus.replace(/\|/g, '-')} | Multiple Choice | ${s.opsi.A.replace(/\|/g, '-')} | ${s.opsi.B.replace(/\|/g, '-')} | ${s.opsi.C.replace(/\|/g, '-')} | ${s.opsi.D.replace(/\|/g, '-')} | ${s.kunci === 'A' ? 1 : s.kunci === 'B' ? 2 : s.kunci === 'C' ? 3 : 4} | 45 |`).join('\n')}

---

## 🔑 KUNCI JAWABAN & PEMBAHASAN GURU
${tk.soalHots.map(s => `${s.nomor}. **Kunci: ${s.kunci}** | *Pembahasan:* ${s.pembahasan}`).join('\n')}`;
}

export function generateStructuredAssessment(
  arg1?: any,
  arg2?: any
): string {
  const materi = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.materi || 'Materi PAI SD') : (arg1 || 'Materi PAI SD');
  const faseKelas = (typeof arg1 === 'object' && arg1 !== null) ? (arg1.faseKelas || 'Fase B') : (arg2 || 'Fase B');
  const tk = resolveThematicKnowledge(materi, (typeof arg1 === 'object' && arg1 !== null) ? (arg1.elemen || '') : '');

  return `# INSTRUMEN PENILAIAN & ASESMEN PEMBELAJARAN
## MATERI POKOK: ${materi.toUpperCase()} (${faseKelas})
**Standar:** Kurikulum Merdeka PAI SD & BSKAP 032/H/KR/2024

---

### 1. RUBRIK OBSERVASI SIKAP (8 DIMENSI PROFIL LULUSAN & RAHMATAN LIL 'ALAMIN)
| No | Dimensi Karakter | Sangat Berkembang (4) | Berkembang Sesuai Harapan (3) | Mulai Berkembang (2) | Butuh Bimbingan (1) |
|:--:|:---|:---|:---|:---|:---|
| 1 | **Keimanan & Ketundukan Spiritual** | Menunjukkan penghayatan doa dan zikir dengan sangat khusyuk secara mandiri | Berdoa dengan tertib dan khusyuk | Berdoa jika diingatkan guru | Kurang fokus dan bercanda saat berdoa |
| 2 | **Integritas Kejujuran & Tanggung Jawab** | Selalu jujur dalam perkataan dan tugas tanpa perlu diawasi | Jujur dalam sebagian besar aktivitas sekolah | Terkadang tergoda berbuat curang saat ulangan | Sering tidak jujur dan mengelak dari tanggung jawab |
| 3 | **Empati & Kasih Sayang (Anti-Bullying)** | Aktif menolong teman, menolak ejekan, dan merangkul semua kawan | Bersikap ramah dan tidak mengejek teman | Sesekali melontarkan candaan yang menyinggung kawan | Terlibat dalam perundungan verbal/fisik |
| 4 | **Bernalar Kritis** | Mampu menganalisis sebab-akibat dalil dan fenomena moral secara mendalam | Mampu menjawab pertanyaan analisis dengan baik | Menjawab pertanyaan secara tekstual sederhana | Mengalami kesulitan memahami konsep dasar |

---

### 2. LEMBAR PENILAIAN DIRI SISWA (MINDFUL REFLECTION)
Berikan tanda centang (✓) pada kolom yang paling menggambarkan dirimu:
1. [ ] Saya merasa damai dan bahagia saat mengamalkan ajaran ${materi}.
2. [ ] Saya berusaha menahan amarah dan berkata santun kepada orang tua dan guru.
3. [ ] Saya bersedia meminta maaf secara tulus jika melakukan kesalahan kepada teman.
4. [ ] Saya berkomitmen menjadi pembawa kedamaian dan menolak segala bentuk perundungan di sekolah.`;
}

export function generateStructuredBahanAjar(data: Partial<ModulInputData>): string {
  const materi = data.materi || 'Mengenal Asmaul Husna: Al-Alim dan Al-Khabir';
  const faseKelas = data.faseKelas || 'Fase B (SD Kelas 3-4)';
  const elemen = data.elemen || 'Akidah';
  const guru = data.namaGuru || 'Pendidik PAI SD';
  const sekolah = data.namaSekolah || 'SD Negeri';
